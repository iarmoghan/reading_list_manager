...
# docker build -t reading_list_manager .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name reading_list_manager reading_list_manager
